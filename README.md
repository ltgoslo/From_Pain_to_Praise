...
- norbert-absa-fine: Sentence-level, fine-grained aspects, fine-tuned on the train split
- norbert-absa-coarse: Sentence-level, coarse-grained aspects, fine-tuned on the train split
- norbert-absa-fine-full: Sentence-level, fine-grained aspects, fine-tuned on the full dataset
- norbert-absa-coarse-full: Sentence-level, coarse-grained aspects, fine-tuned on the full dataset
